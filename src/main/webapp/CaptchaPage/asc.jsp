...
<h1 id="title_1"  style="COLOR:#7eff33; TEXT-ALIGN: center; FONT-SIZE:14; FONT-FAMILY: Verdana; " >Mi primer Captcha Matemático ASC</h1>
<div align=" center" >
...
<div class="row">
    <div class="col"></div>    <div class="col"> 
        <select class="form-control" id="select_1" style=" COLOR:null; FONT-SIZE: 10pt; FONT-FAMILY: Arial;" >
 <option style=" COLOR:null; FONT-SIZE: 10pt; FONT-FAMILY: Arial;"  >   OPCION  5 </option>
 <option style=" COLOR:null; FONT-SIZE: 10pt; FONT-FAMILY: Arial;"  >   OPCION  4 </option>
 <option style=" COLOR:null; FONT-SIZE: 10pt; FONT-FAMILY: Arial;"  >   OPCION  3 </option>
 <option style=" COLOR:null; FONT-SIZE: 10pt; FONT-FAMILY: Arial;"  >   OPCION  2 </option>
 <option style=" COLOR:null; FONT-SIZE: 10pt; FONT-FAMILY: Arial;"  > OPCION 1</option>
        </select>
    </div>
    <div class="col"></div>
</div>
